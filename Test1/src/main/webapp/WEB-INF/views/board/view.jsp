...
//댓굴추가
	...
	$("#btnUpdate").click(function() {
		if (confirm('정말 수정할까요?')) {
			location.href = "/myapp/board/update/${board.num}"
		}
	})
	$("#btnDelete").click(function() {
		...
		$.ajax({
			type : "delete",
			url : "/myapp/board/delete/${board.num}",
