...
//댓굴추가
	$("#commentBtn").click(function() {
		...
		$.ajax({
			type : "post",
			url : "/myapp06/reply/commentInsert",
	...
	$("#btnUpdate").click(function() {
		if (confirm('정말 수정할까요?')) {
			location.href = "/myapp06/update/${board.num}"
		}
	})
